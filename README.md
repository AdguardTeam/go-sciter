...
[![License](https://img.shields.io/github/license/sciter-sdk/go-sciter.svg)](https://github.com/AdguardTeam/go-sciter)
...
Thus the `import path` for golang should now be `github.com/AdguardTeam/go-sciter`, but the package name is still `sciter`.
...
###  At the moment only **Go 1.10** or higher is supported (issue #136).
 ...
 4. `go get -x github.com/AdguardTeam/go-sciter`
